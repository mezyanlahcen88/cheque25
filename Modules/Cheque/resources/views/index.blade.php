<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.cheque_form_manage_cheques'),
            'createPermission' => 'cheque-create',
            'createRoute' => route('cheque.create'),
            'createText' => trans('translation.cheque_action_add'),
            'deletedPermission' => 'cheque-trashed',
            'deletedRoute' => route('cheque.trashed'),
            'deletedText' => trans('translation.cheque_form_deleted_cheques_list'),
        ])
          @endsection
