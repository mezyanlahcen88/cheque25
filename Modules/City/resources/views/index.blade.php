<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.city_form_manage_cities'),
            'createPermission' => 'city-create',
            'createRoute' => route('city.create'),
            'createText' => trans('translation.city_action_add'),
            'deletedPermission' => 'city-trashed',
            'deletedRoute' => route('city.trashed'),
            'deletedText' => trans('translation.city_form_deleted_cities_list'),
        ])
          @endsection
