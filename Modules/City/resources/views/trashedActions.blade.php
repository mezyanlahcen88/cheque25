    <div class="d-flex justify-content-center gap-2">
        @can('city-restore')
        <form action="{{ route('city.restore', $object->id)}}" method="POST" id="restoreForm">
            @csrf
            @method('PUT')
        ...
        @endcan
        @can('city-force-delete')
            <div class="remove">
                <a href="#" class="remove-item-btn" data-bs-toggle="modal"
                data-id="{{ $object->id }}" data-route-name="{{ route('city.forceDelete', $object->id) }}">
