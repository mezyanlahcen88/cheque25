...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('permissions')->insert([
            ...
            ['name' => 'country-create', 'libele' => 'Create', 'guard_name' => 'web', 'groupe_id' =>3, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['name' => 'country-show', 'libele' => 'Show', 'guard_name' => 'web', 'groupe_id' =>3, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['name' => 'country-edit', 'libele' => 'Edit', 'guard_name' => 'web', 'groupe_id' =>3, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['name' => 'country-delete', 'libele' => 'Delete', 'guard_name' => 'web', 'groupe_id' =>3, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['name' => 'country-list', 'libele' => 'List', 'guard_name' => 'web', 'groupe_id' =>3, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
