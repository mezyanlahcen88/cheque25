<x-default-layout>
                ...
                <div class="card card-bordered">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-md-3 my-1">
                                                                <label
                                                                    ...
                                                                    <input class="form-check-input item-checkbox"
                                                                        ...
                                                                        name="permissions[]" data-groupe-name="{{ $groupe->name }}">
                                                                    <span
                            ...
                            @error('permissions')
                                <div class="col-md-12">
                                    <span role="alert" style="color: #f8285a;">
    ...
    @push('scripts')
<script src="{{URL::asset('assets/js/modules/role-module.js')}}"></script>
{{-- {!! JsValidator::formRequest('Modules\Role\App\Http\Requests\StoreRoleRequest'); !!} --}}
