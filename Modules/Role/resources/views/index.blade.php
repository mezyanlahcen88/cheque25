<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            ...
            'createText' => trans('translation.role_action_add'),
            'deletedPermission' => 'role-trashed',
            'deletedRoute' => route('role.create'),
            'deletedText' => trans('translation.role_form_deleted_roles_list'),
        ])
    @endsection
  <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-flush h-md-100">
                        ...
                        <div class="d-flex flex-column text-gray-600">
                            @foreach($role->permissions->shuffle()->take(5) ?? [] as $permission)
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>{{ ucfirst($permission->libele) }}</div>
                            @endforeach
                    ...
                    <div class="card-footer flex-wrap pt-0">
                        <a href="{{ route('role.edit', $role->id) }}" class="btn btn-light btn-active-light-primary my-1" data-role-id="{{ $role->name }}" >{{ trans('translation.role_action_edit') }}</a>
                    </div>
                    <!--end::Card footer-->
                </div>
                <!--end::Card-->
            ...
            <div class="card h-md-100">
                ...
                <div class="card-body d-flex flex-center">
                    ...
                    <a href="{{route('role.create')}}" class="btn btn-clear d-flex flex-column flex-center" >
                        ...
                        <!--end::Illustration-->
                        <!--begin::Label-->
                        <div class="fw-bold fs-3 text-gray-600 text-hover-primary">{{ trans('translation.role_action_add') }}</div>
                        <!--end::Label-->
                    </a>
                    <!--begin::Button-->
                </div>
    ...
    @push('scripts')
        <script src="{{ URL::asset('assets/custom_js/roles.js') }}"></script>
