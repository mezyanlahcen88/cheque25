    <div class="d-flex justify-content-center gap-2">
        @can('brand-restore')
        <form action="{{ route('brand.restore', $object->id)}}" method="POST" id="restoreForm">
            @csrf
            @method('PUT')
        ...
        @endcan
        @can('brand-force-delete')
            <div class="remove">
                <a href="#" class="remove-item-btn" data-bs-toggle="modal"
                data-id="{{ $object->id }}" data-route-name="{{ route('brand.forceDelete', $object->id) }}">
