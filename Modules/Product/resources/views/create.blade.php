                    ...
                    <div class="card-body">
                        ...
                        <x-image-field :background-url="url('/assets/media/svg/avatars/blank.svg')" :image-url="url('/assets/media/avatars/300-1.jpg')" avatar-name="picture" model="product"/>
                            ...
                            <x-input-field cols="col-md-6" divId="stock" column="stock" model="product"
                                ...
                                columnValue="{{ old('stock') }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="stock_alert" column="stock_alert" model="product"
                                ...
                                columnValue="{{ old('stock_alert') }}" attribute="" readonly="false" />
                            ...
                            <x-input-field cols="col-md-6" divId="buy_price" column="buy_price" model="product"
                                ...
                                columnValue="{{ old('buy_price') }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="lot_number" column="lot_number" model="product"
                                ...
                                columnValue="{{ old('lot_number') }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="date_of_expiration" column="date_of_expiration" model="product"
                                ...
                                columnValue="{{ old('date_of_expiration') }}" attribute="" readonly="false" />
