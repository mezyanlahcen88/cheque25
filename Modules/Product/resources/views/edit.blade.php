                    ...
                    <div class="card-body">
                        ...
                        <x-image-field :background-url="url('/assets/media/svg/avatars/blank.svg')" :image-url="url(URL::asset(getPicture($object->picture,'products')))" avatar-name="picture" model="product"/>
                            ...
                            <x-ckeditor-field
                                ...
                                columnValue="{{ $object->description }}"
                                divID="description"
                            />
                            ...
                            <x-input-field cols="col-md-6" divId="stock" column="stock" model="product"
                                optional="text-primary" inputType="number" className="" columnId="stock"
                                columnValue="{{ $object->stock }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="stock_alert" column="stock_alert" model="product"
                                optional="text-primary" inputType="number" className="" columnId="stock_alert"
                                columnValue="{{ $object->stock_alert }}" attribute="" readonly="false" />
                            ...
                            <x-input-field cols="col-md-6" divId="buy_price" column="buy_price" model="product"
                                optional="text-primary" inputType="number" className="" columnId="buy_price"
                                columnValue="{{ $object->buy_price }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="lot_number" column="lot_number" model="product"
                                optional="text-primary" inputType="text" className="" columnId="lot_number"
                                columnValue="{{ $object->lot_number }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="date_of_expiration" column="date_of_expiration" model="product"
                                optional="text-primary" inputType="datetime-local" className="" columnId="date_of_expiration"
                                columnValue="{{ $object->date_of_expiration }}" attribute="" readonly="false" />
