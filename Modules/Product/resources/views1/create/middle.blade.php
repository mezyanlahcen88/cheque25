                ...
                <div class="text-muted fs-7 mt-5">Set the product thumbnail image. Only *.png, *.jpg and *.jpeg
                    ...
                    <div class="card card-flush py-4">           
                        <div class="card-body pt-0 row">
                            ...
                            {{-- <x-ckeditor-field cols="col-md-12" divID="auth_description"
                                column="auth_description" model="setting" optional="text-primary"
                                columnId="auth_description" columnValue="{!! getSettings()['auth_description'] !!}"
                                readonly="false" /> --}}
                            {{-- </div> --}}
                        </div>
                    </div>
