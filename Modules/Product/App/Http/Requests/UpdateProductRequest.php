...
'stock' => ['bail', 'nullable', 'string'],
'stock_alert' => ['bail', 'nullable', 'string'],
'buy_unit' => ['bail', 'required', 'string'],
'buy_price' => ['bail', 'nullable', 'numeric'],
'lot_number' => ['bail', 'nullable', 'string'],
'date_of_expiration' => ['bail', 'nullable', 'date_format:Y-m-d H:i:s'],
