                ...
                <form action="{{ route('society.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <x-single-select cols="col-md-6" div-id="site_id" column="site_id" model="society"
                            label="society_form_site_id" optional="text-danger" id="site_id" :options="sites()"
                            :object=false />
                        ...
                        <x-single-select cols="col-md-6" div-id="state_id" column="state_id" model="society"
                            label="society_form_state_id" optional="text-primary" id="state_id" :options="states()"
                            :object=false />
                        <x-single-select cols="col-md-6" div-id="city_id" column="city_id" model="society"
                            label="society_form_city_id" optional="text-primary" id="city_id" :options="cities()"
                            :object=false />
                        <x-single-select cols="col-md-6" div-id="secteur_id" column="secteur_id" model="society"
                            label="society_form_secteur_id" optional="text-primary" id="secteur_id" :options="secteurs()"
                            :object=false />
                        ...
                        <x-ckeditor-field cols="col-md-12" column="comment" model="society" optional="text-primary"
                            columnValue="{{ old('comment') }}" divID="comment" />
                        <x-save-button />
                    </div>
                </form>
            </div>
