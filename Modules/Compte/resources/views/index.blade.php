<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.compte_form_manage_comptes'),
            'createPermission' => 'compte-create',
            'createRoute' => route('compte.create'),
            'createText' => trans('translation.compte_action_add'),
            'deletedPermission' => 'compte-trashed',
            'deletedRoute' => route('compte.trashed'),
            'deletedText' => trans('translation.compte_form_deleted_comptes_list'),
        ])
          @endsection
