<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.site_form_manage_sites'),
            'createPermission' => 'site-create',
            'createRoute' => route('site.create'),
            'createText' => trans('translation.site_action_add'),
            'deletedPermission' => 'site-trashed',
            'deletedRoute' => route('site.trashed'),
            'deletedText' => trans('translation.site_form_deleted_sites_list'),
        ])
          @endsection
