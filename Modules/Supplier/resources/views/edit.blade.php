<x-default-layout>
    ...
    @endsection
                ...
                <div class="card card-bordered">
                    <div class="card-header">
                        <h3 class="card-title">{{trans('translation.supplier_action_edit')}}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('supplier.update', $object->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        <div class="row">
                        ...
                        <x-image-field :background-url="url('/assets/media/svg/avatars/blank.svg')" :image-url="url('/assets/media/avatars/300-1.jpg')" avatar-name="picture" />
                            ...
                            <x-input-field cols="col-md-6" divId="ice" column="ice" model="supplier"
                                ...
                                columnValue="{{ $object->ice }}" attribute="required" readonly="false" />
                            ...
                            <x-input-field cols="col-md-6" divId="fonction" column="fonction" model="supplier"
                                ...
                                columnValue="{{ $object->fonction }}" attribute="" readonly="false" />
                            <x-input-field cols="col-md-6" divId="phone" column="phone" model="supplier"
                                ...
                                columnValue="{{ $object->phone }}" attribute="unique:suppliers" readonly="false" />
                            ...
                            <x-input-field cols="col-md-6" divId="email" column="email" model="supplier"
                                ...
                                columnValue="{{ $object->email }}" attribute="unique:suppliers" readonly="false" />
                            <x-single-select cols="col-md-6" div-id="state_id" column="state_id" model="supplier"
                                label="supplier_form_state_id" optional="text-primary" id="state_id" :options="states()" :object=$object />
                            <x-single-select cols="col-md-6" div-id="city_id" column="city_id" model="supplier"
                                label="supplier_form_city_id" optional="text-primary" id="city_id" :options="cities()" :object=$object />
                            <x-single-select cols="col-md-6" div-id="secteur_id" column="secteur_id" model="supplier"
                                label="supplier_form_secteur_id" optional="text-primary" id="secteur_id" :options="secteurs()" :object=$object />
    ...
    @push('scripts')
    {!! JsValidator::formRequest('Modules\Supplier\App\Http\Requests\UpdateSupplierRequest'); !!}
    @endpush
</x-default-layout>
