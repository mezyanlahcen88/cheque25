<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            ...
            'createPermission' => 'employe-create',
            'createRoute' => route('employe.create'),
            'createText' => trans('translation.employe_action_add'),
            'deletedPermission' => 'employe-trashed',
            'deletedRoute' => route('employe.trashed'),
            'deletedText' => trans('translation.employe_form_deleted_employes_list'),
        ])
          @endsection
