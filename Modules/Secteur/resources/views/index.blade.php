<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.secteur_form_manage_secteurs'),
            'createPermission' => 'secteur-create',
            'createRoute' => route('secteur.create'),
            'createText' => trans('translation.secteur_action_add'),
            'deletedPermission' => 'secteur-trashed',
            'deletedRoute' => route('secteur.trashed'),
            'deletedText' => trans('translation.secteur_form_deleted_secteurs_list'),
        ])
          @endsection
 <div class="card card-p-1 card-flush">
        ...
        <div class="card-body">
            <div class="table-responsive">
                @include('secteur::table', ['model' => 'secteur'])
            </div>
        </div>
    </div>
    @push('scripts')
