<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.carnet_form_manage_carnets'),
            'createPermission' => 'carnet-create',
            'createRoute' => route('carnet.create'),
            'createText' => trans('translation.carnet_action_add'),
            'deletedPermission' => 'carnet-trashed',
            'deletedRoute' => route('carnet.trashed'),
            'deletedText' => trans('translation.carnet_form_deleted_carnets_list'),
        ])
          @endsection
