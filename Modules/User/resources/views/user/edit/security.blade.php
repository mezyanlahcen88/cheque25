        ...
        <div class="card pt-4 mb-6 mb-xl-9">
            ...
            <div class="card-body pt-2 pb-5">
                <form action="#" method="post" id="user_security_form">
                    <div class="row">
                        <x-input-field cols="col-md-4" divId="old_password" column="old_password" model="user"
                        ...
                        <x-input-field cols="col-md-4" divId="new_password" column="new_password" model="user"
                        ...
                        <x-input-field cols="col-md-4" divId="new_password_confirmation"
