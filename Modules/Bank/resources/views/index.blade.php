<x-default-layout>
    @section('breadcrumb')
        @include('components.breadcrumb', [
            'title' => trans('translation.bank_form_manage_banks'),
            'createPermission' => 'bank-create',
            'createRoute' => route('bank.create'),
            'createText' => trans('translation.bank_action_add'),
            'deletedPermission' => 'bank-trashed',
            'deletedRoute' => route('bank.trashed'),
            'deletedText' => trans('translation.bank_form_deleted_banks_list'),
        ])
          @endsection
